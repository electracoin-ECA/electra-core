...
//const uint8_t stealth_version_byte = 0x28; // dec 40
...
std::string CStealthAddress::Encoded() const
{
    ...
    data_chunk raw;
    raw.push_back(Params().Base58Prefix(CChainParams::STEALTH_ADDRESS)[0]);
...
int GenerateRandomSecret(ec_secret& out)
{
    ...
    static uint256 max = uint256("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364140");
    static uint256 min = uint256(16000); // increase? min valid key is 1
